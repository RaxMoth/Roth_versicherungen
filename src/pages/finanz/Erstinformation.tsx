...
import { FINANZ_LEGAL } from '@/content'
import { usePageMeta } from '@/hooks/usePageMeta'

const Erstinformation = () => {
    usePageMeta({
        title: `Erstinformation – ${FINANZ_LEGAL.short}`,
        description:
            'Erstinformation für Kunden gemäß § 15 VersVermV: Status, Vergütung und Schlichtungsstellen für Roth Finanz.',
    })
        ...
        <>
            ...
            <Section eyebrow="Status" title="Rechtlicher Status." bg="page">
                <div className="space-y-5 text-stone-700 leading-relaxed text-lg max-w-3xl">
                    <p>
                        ...
                        {f.erlaubnisVersicherung} sowie als Immobilien- und
                        Finanzmakler nach {f.erlaubnisFinanz} zugelassen.
                    </p>
                    <p>
                        ...
                        <br />
                        {f.aufsichtVersicherung} (Versicherungs­vermittlung)
                        <br />
                        {f.aufsichtFinanz} (Immobilien- und
                        Finanz­vermittlung)
                    </p>
                    <p>
                    ...
                    <p>
                        <strong>Registernummer:</strong> {f.vermittlerNr}
                    </p>
                </div>
            </Section>
            ...
            <Section eyebrow="Vergütung" title="Wie wir vergütet werden.">
                <p className="text-stone-700 leading-relaxed text-lg max-w-3xl">
                    Die Vergütung – Courtage genannt – für unsere Beratungs-
                    und Vermittlungstätigkeit erhalten wir in der Regel von
                    den Versicherungs­gesellschaften als Bestandteil der
                    Versicherungsprämie. Bei Nettoprodukten sind im Beitrag
                    keine Courtagen einkalkuliert; in diesem Fall
                    vereinbaren wir die Vergütung gesondert mit Ihnen.
                    Sonstige Zuwendungen erhalten wir nicht.
                </p>
            </Section>
            ...
            >
                <p className="text-stone-700 leading-relaxed text-lg max-w-3xl">
                    ...
                    Versicherungs­unternehmens. Umgekehrt halten auch keine
            ...
            >
                <p className="text-stone-700 leading-relaxed text-lg max-w-3xl">
                    ...
                    Anlagen, insbesondere ESG-konformen Investmentfonds im
                    Rahmen von Versicherungsprodukten. Die Vergütung
                    unterscheidet sich dabei nicht von konventionellen
                    Produkten.
                </p>
            </Section>
        </>
