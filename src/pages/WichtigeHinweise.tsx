...
const blocks: Block[] = [
    ...
    {
        title: 'Lebens-, Berufsunfähigkeits- und Rentenversicherung',
        items: [
...
const WichtigeHinweise: React.FC = () => (
    <>
        <PageHero
            eyebrow="Wichtige Hinweise"
            title="Schneller zum Ziel."
            subtitle="Mit einer guten Vorbereitung fällt vieles leichter. Wir haben die wichtigsten Hinweise für Sie zusammengestellt, damit Sie Zeit und Wege sparen."
