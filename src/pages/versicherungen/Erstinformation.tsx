...
import { VERSICHERUNGEN_LEGAL } from '@/content'
import { usePageMeta } from '@/hooks/usePageMeta'

const Erstinformation = () => {
    usePageMeta({
        title: `Erstinformation – ${VERSICHERUNGEN_LEGAL.short}`,
        description:
            'Erstinformation für Kunden gemäß § 15 VersVermV: Status, Vergütung und Schlichtungsstellen.',
    })
        ...
        <>
            ...
            <Section eyebrow="Status" title="Rechtlicher Status." bg="page">
                <p className="text-stone-700 leading-relaxed text-lg max-w-3xl">
                    Wir sind als Versicherungs­makler nach {v.erlaubnis} bei
                    der zuständigen IHK zugelassen und in das
                    Vermittlerregister der DIHK eingetragen. Die Eintragung
                    kann unter{' '}
                    <a
                    ...
                    oder telefonisch unter (0180) 6 00 58 50 überprüft
                    werden.
                </p>
                <p className="mt-4 text-stone-900 text-lg">
                    <strong>Registernummer:</strong> {v.vermittlerNr}
                </p>
            </Section>

            <Section eyebrow="Vergütung" title="Wie wir vergütet werden.">
                <p className="text-stone-700 leading-relaxed text-lg max-w-3xl">
                    Als Versicherungs­makler erhalten wir – wie marktüblich –
                    von den Versicherungs­gesellschaften eine Courtage.
                    Diese ist Teil der Versicherungsprämie. Bei sogenannten
                    Nettoprodukten sind im Beitrag keine Courtagen
                    einkalkuliert; in diesem Fall vereinbaren wir die
                    Vergütung gesondert mit Ihnen. Sonstige Zuwendungen
                    erhalten wir nicht.
                </p>
            </Section>
            ...
            >
                <p className="text-stone-700 leading-relaxed text-lg max-w-3xl">
                    ...
                    unmittelbare oder mittelbare Beteiligung von über 10 %
                    an den Stimmrechten oder am Kapital eines
                    Versicherungs­unter­nehmens. Umgekehrt halten auch keine
                    Versicherungs­gesellschaften vergleichbare
            ...
            >
                <p className="text-stone-700 leading-relaxed text-lg max-w-3xl">
                    Im Rahmen unserer Beratung berücksichtigen wir auf
                    Wunsch Nachhaltigkeits­faktoren in Anlageentscheidungen
                    (ESG-konforme Investmentfonds). Die Vergütungen
                    unterscheiden sich dabei nicht von denen
