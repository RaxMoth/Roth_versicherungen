...
// Team
import carlo from '../assets/site/carlo.jpg'
import petra from '../assets/site/petra.png'
import williams from '../assets/site/williams.jpg'
import sabrina from '../assets/site/sabrina.jpg'
import dogs from '../assets/site/dogs.jpg'

export const IMAGES = {
    home,
    versicherungen: versicherungenHero,
    versicherungenContent,
    firmenkunden,
    cyber: cyberPolice,
    privatkunden,
    tier,
    hinweise: wichtigeHinweise,
    jobs,
    finanz: finanzHero,
    finanzLogo,
    altersversorgung,
    sterbegeld,
    online: onlineBeratung,
    serviceapp: serviceApp1,
    kontakt,
    erstinfo: versicherungenContent,
    datenschutz: wichtigeHinweise,
    impressum: versicherungenContent,
    team: versicherungenContent,
    history: versicherungenHero,
    consulting: kontakt,
}
