export const SERVICEAPP = {
    meta: {
        title: "Service App",
        description:
            "Die VEMA MaklerApp: Schäden melden, Policen prüfen lassen, Beratung anfordern – alles mobil und unkompliziert.",
    },
    ...
    hero: {
        ...
        title: "ServiceApp.",
        subtitle:
            "In Zusammenarbeit mit der VEMA Versicherungs-Makler-Genossenschaft eG haben wir eine Service-App entwickelt.",
    },

    features: {
        eyebrow: "Mit der App können Sie",
    ...
    install: {
        eyebrow: "Anmeldung",
        title: "Installation und Login.",
        body: "Bitte suchen Sie in beiden Stores unter dem Stichwort VEMA MaklerApp und geben Sie den Code bzw. Code und Benutzernamen ein. Bitte achten Sie auf Groß- und Kleinschreibung. Nach der Installation müssen Sie sich einmalig anmelden.",
        username: "VEMA",
        code: "MTM0fA",
        appStoreUrl: "https://apps.apple.com/de/app/vema/id1515267946",
        playStoreUrl:
            "https://play.google.com/store/apps/details?id=com.mycasavi.vema&hl=de",
    },
};
